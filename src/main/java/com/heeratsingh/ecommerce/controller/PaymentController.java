...
import com.heeratsingh.repository.OrderRepository;
import com.heeratsingh.response.ApiResponse;
import com.heeratsingh.response.PaymentLinkResponse;
import com.heeratsingh.service.OrderService;
import com.heeratsingh.service.UserService;
import com.heeratsingh.user.domain.OrderStatus;
import com.heeratsingh.user.domain.PaymentStatus;
...
//		      paymentLinkRequest.put("reference_id",order.getId().toString());
            ...
            paymentLinkRequest.put("callback_url","https://shopwithheeratsingh.vercel.app/payment/"+orderId);
...
//			order.setOrderItems(order.getOrderItems());
            ...
            new RedirectView("https://shopwithheeratsingh.vercel.app/payment/failed");
            throw new RazorpayException(e.getMessage());
        }
